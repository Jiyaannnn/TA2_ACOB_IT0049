...
<section class="hero" aria-labelledby="dashboard-title">
    <div class="hero-copy-block">
        ...
        <p class="hero-copy">Ledgerline keeps customer contacts and staff accounts in one precise, persistent directory. CodeIgniter Models retrieve every row from MySQL as you browse.</p>
